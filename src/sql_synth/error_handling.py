...
class ErrorClassifier:
    ...
    def classify_error(cls, error: Exception) -> ErrorCategory:
        ...
        elif "sql" in error_type or "query" in error_type:
            return ErrorCategory.SQL_EXECUTION
        elif "validation" in error_type or "security" in error_type:
...
def retry_with_backoff(
    ...
    def wrapper(*args, **kwargs) -> T:
        ...
        if last_error_context:
            ...
            elif last_error_context.category == ErrorCategory.SQL_GENERATION:
                raise SQLGenerationError(last_error_context)
            elif last_error_context.category == ErrorCategory.SQL_EXECUTION:
